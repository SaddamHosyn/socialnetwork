...
func main() {
	...
	// ADD THESE MISSING GROUP ENDPOINTS:
	...
	http.Handle("/api/groups/join", handlers.AuthMiddleware(http.HandlerFunc(handlers.RequestJoinGroupHandler)))
	http.Handle("/api/groups/invitation/handle", handlers.AuthMiddleware(http.HandlerFunc(handlers.HandleInvitationHandler)))
	http.Handle("/api/groups/request/handle", handlers.AuthMiddleware(http.HandlerFunc(handlers.HandleJoinRequestHandler)))
	...
	http.Handle("/api/groups/requests", handlers.AuthMiddleware(http.HandlerFunc(handlers.FetchGroupJoinRequests)))
