...
func CreateGroupInvitationNotification(inviteeID, inviterID int, inviterName, groupName string, invitationID int) error {
	log.Printf("📧 CreateGroupInvitationNotification called: inviteeID=%d, inviterID=%d, inviterName=%s, groupName=%s, invitationID=%d",
		inviteeID, inviterID, inviterName, groupName, invitationID)
